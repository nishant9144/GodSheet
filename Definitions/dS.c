...
//     // Create cells and cell mapping
//     Cell** cellMap = (Cell**)malloc((numVertices + 1) * sizeof(Cell*));
//     for (int i = 1; i <= numVertices; i++) {
//         // Create column name (A, B, C, etc.)
//         char col[2] = {(char)('A' + i - 1), '\0'};
//         if(i == 1) {
//             cellMap[i] = create_cell(1, col, i);
//         } else {
//             cellMap[i] = create_cell(2, col, i);
//         }
//     }

//     // Initialize adjacency matrix
//     Vector adjMatrix[numVertices + 1];
//     for (int i = 1; i <= numVertices; i++) {
//         vector_init(&adjMatrix[i]);
//     }
    
//     // Create edges (same as original example)
//     vector_push_back(&adjMatrix[6], cellMap[1]);  // 6 -> 1
//     vector_push_back(&adjMatrix[6], cellMap[3]);  // 6 -> 3
//     vector_push_back(&adjMatrix[5], cellMap[1]);  // 5 -> 1
//     vector_push_back(&adjMatrix[5], cellMap[2]);  // 5 -> 2
//     vector_push_back(&adjMatrix[3], cellMap[4]);  // 3 -> 4
//     vector_push_back(&adjMatrix[4], cellMap[2]);  // 4 -> 2
    
//     // Perform topological sort
//     Vector sortedOrder = create_and_sort_graph(numVertices, adjMatrix, cellMap);
    
//     // Print results
//     printf("Topologically Sorted Order:\n");
//     VectorIterator sortedIt;
//     vector_iterator_init(&sortedIt, &sortedOrder);
//     while (vector_iterator_has_next(&sortedIt)) {
//         Cell* cell = vector_iterator_next(&sortedIt);
//         printf("%s%d (%d) ", cell->col, cell->row, cell->topo_order);
//     }
//     printf("\n");

//     Set testingremove;
//     set_init(&testingremove);
//     set_add(&testingremove, cellMap[1]);
//     set_add(&testingremove, cellMap[2]);
//     set_add(&testingremove, cellMap[3]);
//     set_remove(&testingremove, cellMap[2]);
//     SetIterator it;
//     set_iterator_init(&it, &testingremove);
//     while (set_iterator_has_next(&it)) {
//         Cell* cell = set_iterator_next(&it);
//         printf("%s%d ", cell->col, cell->row);
//     }
//     printf("\n");
//     set_free(&testingremove);

    
//     // Free all resources
//     vector_free(&sortedOrder);
//     for (int i = 1; i <= numVertices; i++) {
//         vector_free(&adjMatrix[i]);
//         free_cell(cellMap[i]);
//     }
//     free(cellMap);
...
//     vector_push_back(&adjMatrix[6], 1);
//     vector_push_back(&adjMatrix[6], 3);
//     vector_push_back(&adjMatrix[5], 1);
//     vector_push_back(&adjMatrix[5], 2);
//     vector_push_back(&adjMatrix[3], 4);
//     vector_push_back(&adjMatrix[4], 2);
    
//     Vector sortedOrder = create_and_sort_graph(numVertices, adjMatrix);
    
//     VectorIterator sortedIt;
//     vector_iterator_init(&sortedIt, &sortedOrder);
//     printf("Topologically Sorted Order:\n");
//     while (vector_iterator_has_next(&sortedIt)) {
//         printf("%d ", vector_iterator_next(&sortedIt));
//     }
//     printf("\n");
